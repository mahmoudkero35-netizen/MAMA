          ...
          <AnimatePresence>
            {category.products && category.products.length > 0 ? (
              ...
              >
                ...
                <p className="text-gray-500 text-xl">·«  ÊÃœ „‰ Ã«  ›Ì Â–Â «·›∆…</p>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
...
function AnimatedMenu({ settings }) {
  ...
  const loadMenu = async () => {
    try {
      ...
      setError(" ⁄–—  Õ„Ì· «·ﬁ«∆„….  √ﬂœ „‰  ‘€Ì· «·Œ«œ„ «·Œ·›Ì ⁄·Ï «·„‰›– 5000.")
    } finally {
      setLoading(false)
    }
  }
  ...
  const allCategories = [{ id: null, name: "«·ﬂ·", icon: "??" }, ...categories]
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-100 flex items-center justify-center p-4">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Œÿ√ ›Ì «·« ’«·</h2>
      ...
      <section className="relative h-96 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 overflow-hidden flex items-center justify-center">
        ...
        >
          <div className="text-center">
            <div className="text-sm mb-2 opacity-80">„—— ··√”›·</div>
            <motion.div
              animate={{ scale: [1, 1.2, 1] }}
        ...
        <AnimatePresence>
          {filteredCategories.length > 0 ? (
            ...
            >
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-4">·«  ÊÃœ ‰ «∆Ã ”Õ—Ì…</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-gray-400 text-lg">‰ﬁœ„ ·ﬂ„  Ã—»… ÿ⁄«„ ”Õ—Ì… ·«  ı‰”Ï</p>
            </div>

            {/* Contact Info */}
            <div className="text-center">
              <h4 className="text-xl font-semibold mb-6">„⁄·Ê„«  «·« ’«·</h4>
              <div className="space-y-3 text-gray-400">
                ...
                <motion.p whileHover={{ x: 5 }} className="flex items-center justify-center gap-2">
                  <span className="text-2xl">??</span> «·—Ì«÷° «·”⁄ÊœÌ…
                </motion.p>
              </div>
            </div>
            ...
            <div className="text-center md:text-left">
              <h4 className="text-xl font-semibold mb-6">√Êﬁ«  «·⁄„·</h4>
              <div className="space-y-3 text-gray-400">
                <motion.p whileHover={{ x: -5 }}>«·√Õœ - «·Œ„Ì”: 8 ’ - 12 „</motion.p>
                <motion.p whileHover={{ x: -5 }}>«·Ã„⁄… - «·”» : 4 „ - 12 „</motion.p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              © 2024 {settings?.siteName || "„ÿ⁄„‰« «·—«∆⁄"}. Ã„Ì⁄ «·ÕﬁÊﬁ „Õ›ÊŸ….
            </motion.p>
          </motion.div>
        </div>
      </motion.footer>
