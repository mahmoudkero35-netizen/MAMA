    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={styles.background}>
        <div className="text-center">
          ...
          <p className="mt-4" style={{ color: styles.text.color }}>Ã«—Ì  Õ„Ì· «·ﬁ«∆„…...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={styles.background}>
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold mb-2" style={{ color: styles.text.color }}>Œÿ√ ›Ì «·« ’«·</h2>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {categories.length === 0 && (
          <div className="text-center py-12">
            <p style={{ color: styles.text.color }}>·«  ÊÃœ ⁄‰«’— ›Ì «·ﬁ«∆„… Õ«·Ì«</p>
          </div>
        )}
